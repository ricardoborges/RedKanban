...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    loginTitle: 'Log in to RedKanban',
    loginSubtitle: 'Access your Redmine boards',
    loginMethodLabel: 'Authentication Method',
    methodCredentials: 'Username & Password',
    methodApiKey: 'REST API Key',
    usernameLabel: 'Username',
    usernamePlaceholder: 'Enter your Redmine username...',
    passwordLabel: 'Password',
    passwordPlaceholder: 'Enter your Redmine password...',
    loginBtn: 'Log In',
  ...
  'pt-br': {
    ...
    loginTitle: 'Entrar no RedKanban',
    loginSubtitle: 'Acesse seus quadros do Redmine',
    loginMethodLabel: 'Método de Autenticação',
    methodCredentials: 'Usuário e Senha',
    methodApiKey: 'Chave de API REST',
    usernameLabel: 'Usuário',
    usernamePlaceholder: 'Digite seu usuário do Redmine...',
    passwordLabel: 'Senha',
    passwordPlaceholder: 'Digite sua senha do Redmine...',
    loginBtn: 'Entrar',
  ...
  es: {
    ...
    loginTitle: 'Iniciar sesión en RedKanban',
    loginSubtitle: 'Acceda a sus tableros de Redmine',
    loginMethodLabel: 'Método de autenticación',
    methodCredentials: 'Usuario y Contraseña',
    methodApiKey: 'Clave de API REST',
    usernameLabel: 'Usuario',
    usernamePlaceholder: 'Ingrese su usuario de Redmine...',
    passwordLabel: 'Contraseña',
    passwordPlaceholder: 'Ingrese su contraseña de Redmine...',
